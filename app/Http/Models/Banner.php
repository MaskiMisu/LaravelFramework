...
{
    public $table = 'banner';
    public $columns = ['id', 'title', 'showhi','group', 'content', 'picture', 'created_at'];
    public $orderBy = [];
    public $where = [];
    public $orWhere = [];
    public $id = '';
    ...
    public function parse_data($data, $a = 0){
      $arr_parse = array('title', 'alt', 'short', 'content', 'meta_title', 'meta_description', 'meta_keywords');
      if(isset($data->id)){
        foreach ($data as $k => $v) {
