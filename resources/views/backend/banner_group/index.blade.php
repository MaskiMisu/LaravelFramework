...
<div class="row">
  <div class="col-md-6">
    <div class="btn-group pull-left">
      ...
      @else
        <a href="{!! url('backend/banner')!!}" class="btn btn-default">@lang('app.banner')</a>
      @endif
    </div>
  </div>
  <div class="col-md-6">
    <div class="btn-group pull-right">
      <a href="{!! url('backend/banner_group/trash') !!}" class="btn btn-danger">@lang('app.trash')</a>
      <a href="{!! url('backend/banner_group/create') !!}" class="btn btn-primary">@lang('app.create')</a>
    </div>
  </div>
</div>
<hr>
