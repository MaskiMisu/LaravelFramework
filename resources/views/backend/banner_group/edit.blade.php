...
@section('content')
  ...
  <div class="alert alert-success">
    <strong>@lang('app.banner_group')!</strong> @lang('app.update_success')
  </div>
  @endif
    ...
    <div class="panel panel-info panel-light">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <div class="controls">
            <input class="form-control" id="banner_key" name="banner_key" placeholder="@lang('app.banner_key')" type="text" value="{!! $item->banner_key !!}" required>
          </div>
        </div>
      </div>
    </div>
