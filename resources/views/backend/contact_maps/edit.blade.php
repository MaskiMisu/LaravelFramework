...
@section('title')
{{ $item->title }} - @lang('app.contact_maps')
@endsection
@section('content')
@if($status == 1)
<div class="alert alert-success">
  <strong>@lang('app.contact_maps')!</strong> @lang('app.update_success')
</div>
@endif
  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <div class="form-group">
        ...
        <div class="controls">
          <input class="form-control" id="address" name="address" placeholder="@lang('app.address')" type="text" value="{{ $item->address }}" onchange="app.getMap(this)" required>
